const compliments = [
    ...
    "You’ve helped others become a better person.",
    "You are my guiding light.",
    "You’re everything that I asked for.",
    "I am so glad that you chose to be in our lifes.",
    ...
    "Thank you for teaching me how to become a better bot.",
...
function getCompliment() {
    const response = compliments[Math.floor(Math.random() * compliments.length)]
    return response
}
